...
export default function OtpVarificationForm({
  setEmail,
  email,
  nextStep,
  back,
      ...
      <div className="flex justify-center gap-3 mb-6">
        {otp.map((digit, index) => (
          <input
            ...
            className="w-12 h-12 text-center text-lg text-black font-bold bg-white/90 border-2 border-orange-200/70 rounded-xl focus:border-orange-400 focus:outline-none shadow-neumorph-sm"
          />
        ))}
      </div>
