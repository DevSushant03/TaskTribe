...
import { FaTasks, FaCheckCircle, FaClock, FaPlus, FaSearch } from 'react-icons/fa';

const stats = [
  { label: 'Active Tasks', value: 12, icon: <FaTasks />, bgColor: 'bg-orange-600/20', iconColor: 'text-orange-500' },
  { label: 'Completed', value: 28, icon: <FaCheckCircle />, bgColor: 'bg-green-600/20', iconColor: 'text-green-500' },
  { label: 'In Progress', value: 5, icon: <FaClock />, bgColor: 'bg-blue-600/20', iconColor: 'text-blue-500' },
];

const recentTasks = [
  { id: 1, title: 'Create Logo for Mobile App', status: 'in_progress', budget: '₹1.2K' },
  { id: 2, title: 'Fix React Authentication Bug', status: 'open', budget: '₹800' },
  { id: 3, title: 'UI/UX Audit for Landing Page', status: 'completed', budget: '₹2.5K' }
];
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#111] border border-orange-500/50 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="browse" className="text-orange-500 hover:text-orange-400 text-sm font-medium">
                  View All →
                </Link>
              </div>
              <div className="space-y-3">
